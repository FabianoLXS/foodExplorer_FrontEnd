...
O front-end do projeto, responsável pela interface do usuário, está disponível neste repositório. Já o back-end, que lida com a lógica e o armazenamento dos dados, está disponível [aqui](https://github.com/FabianoLXS/foodExplorer_BackEnd).
...
A aplicação Food Explorer está disponível para uso [aqui](https://foodexplorerrocket.netlify.app/).
